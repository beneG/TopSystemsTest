...
#ifndef _WXWIDGETSTEST_WXWIDGETSTEST_WXCRAFTER_BASE_CLASSES_H
#define _WXWIDGETSTEST_WXWIDGETSTEST_WXCRAFTER_BASE_CLASSES_H
...
protected:
    ...
    wxMenuItem* m_menuItemCreateTriangle;
    wxMenuItem* m_menuItemCreateRectangle;
    wxMenuItem* m_menuItemCreateCircle;
